...
class DataHandler():
    ...
    def __init__(self, batch_size=64, num_batches=2, num_extra_features=2):
        ...
        self.next_batch_image = np.zeros((num_batches * batch_size, 3, 80, 160)).astype('float32')
        self.next_batch_other = np.zeros((num_batches * batch_size, num_extra_features)).astype('float32')
